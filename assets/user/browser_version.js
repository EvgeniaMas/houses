...
var qa = oa(),
    H = E("Trident") || E("MSIE"),
    ra = E("Edge"),
    I = E("Gecko") && !(-1 != D.toLowerCase().indexOf("webkit") && !E("Edge")) && !(E("Trident") || E("MSIE")) && !E("Edge"),
    J = -1 != D.toLowerCase().indexOf("webkit") && !E("Edge");
...
var wa = m.document,
    xa = wa && H ? ta() || ("CSS1Compat" == wa.compatMode ? parseInt(ua, 10) : 5) : void 0;
...
function za(a, b) {
    ...
    if (a) {
        ...
        for (d = e = 0; c = h[d]; d++) {
            var g = c.className,
                p;
            if (p = "function" == typeof g.split) p = 0 <= C(g.split(/\s+/), a);
            p && (f[e++] = c)
        }
        f.length = e;
        return f
...
function O(a, b) {
    for (var c = Ea(a), d = c, e = ka(arguments, 1), f = 0; f < e.length; f++) 0 <= C(d, e[f]) || d.push(e[f]);
    a.className = c.join(" ")
}

function Fa(a, b) {
    var c = Ea(a),
        c = Ga(c, ka(arguments, 1));
    a.className = c.join(" ")
}
...
S.prototype.preventDefault = function() {
    ...
    else if (a.returnValue = !1, Ka) try {
...
U.prototype.add = function(a, b, c, d, e) {
    ...
    a = this.a[f];
    a || (a = this.a[f] = [], this.g++);
    var h = Ra(a, b, d, e); - 1 < h ? (b = a[h], c || (b.l = !1)) : (b = new Qa(b, this.src, f, !!d, e), b.l = c, a.push(b));
    return b
};
...
U.prototype.O = function(a) {
    ...
    for (c in this.a)
        if (!a || c == a) {
            for (var d = this.a[c], e = 0; e < d.length; e++) ++b, T(d[e]);
            delete this.a[c];
            this.g--
        }
    return b
...
U.prototype.hasListener = function(a, b) {
    ...
    return na(this.a, function(a) {
        for (var h = 0; h < a.length; ++h)
            if (!(c && a[h].type != d || e && a[h].h != b)) return !0;
        return !1
    })
};
...
function Ra(a, b, c, d) {
    for (var e = 0; e < a.length; ++e) {
        var f = a[e];
        if (!f.f && f.listener == b && f.h == !!c && f.o == d) return e
    }
    return -1
};
...
function V(a, b, c, d, e) {
    if ("array" == ba(b))
    ...
    else if (c = Xa(c), a && a[Oa]) a.F.add(String(b), c, !1, d, e);
    else {
        ...
        if (!c.i) {
            ...
            else if (a.attachEvent) a.attachEvent($a(b.toString()), d);
...
function ab(a, b) {
    ...
    if (!Ja) {
        ...
        if (!(0 > e.keyCode || void 0 != e.returnValue)) {
            ...
            for (g = 0; !c.u && g < e.length; g++) c.currentTarget =
                e[g],
            p = bb(e[g], f, !1, c),
            d = d && p
        }
...
function fb(a) {
    ...
    for (a = 0; a < X.userAgentParsers.length; a++) {
        var b = new RegExp(X.userAgentParsers[a].regex),
            c = b.exec(navigator.userAgent);
        if (c) return console.log(navigator.userAgent, b, this), X.userAgentParsers[a].familyReplacement ? X.userAgentParsers[a].familyReplacement : c[1]
    }
}
...
function gb(a) {
    ...
    for (a = 0; a < X.userAgentParsers.length; a++) {
        ...
        if (b) return X.userAgentParsers[a].v1Replacement ? (b = X.userAgentParsers[a].v1Replacement, X.userAgentParsers[a].v2Replacement && (b += "." + X.userAgentParsers[a].v2Replacement)) : b = b[2], b
    }
}
...
function hb(a) {
    ...
    for (a = 0; a < X.osParsers.length; a++) {
        ...
        if (b) return X.osParsers[a].osReplacement ? X.osParsers[a].osReplacement : b[1]
    }
}
...
function ib(a) {
    ...
    for (a = 0; a < X.osParsers.length; a++) {
        ...
        if (b) {
            ...
            } else c = "", b[2] && (c += b[2]), b[3] && (c += "." + b[3]), b[4] && (c += "." + b[4]);
            return c
        }
    }
}
...
function Y(a) {
    ...
    for (a = 0; a < X.deviceParsers.length; a++)
        if ((new RegExp(X.deviceParsers[a].regex)).exec(navigator.userAgent)) return !0
}
...
var jb = function() {
    ...
    return {
        ...
        update: function(b, c) {
            if (c)
                for (var d = 0, e = a.length; d < e; d++) a[d].update(b, c);
            else
                for (d = 0, e = a.length; d < e;) a[d].update(b, c) ? d++ : (a.splice(d, 1), e--)
        }
    }
}();
...
function nb() {
    ...
    this.reset = function(d) {
        if (d) {
            ...
            for (var f in c) c.hasOwnProperty(f) && (a[f] = b[f] || a[f]);
        this.update(0, !0)
    };
            ...
            if (b.hasOwnProperty(R)) {
                ...
                if (r instanceof Array) {
                    var A = r.length - 1,
                        F = A * l,
                        G = Math.floor(F);
                    if (0 > l) A = r[0], r = (r[1] - A) * F + A;
                    else if (1 < l) G = r[A], r =
                        (r[A - 1] - G) * (A - F) + G;
                    else var aa = r[G],
                        r = (r[G + 1 > A ? A : G + 1] - aa) * (F - G) + aa
                } else r = F + (r - F) * l;
                a[R] = r
            }
        null !== g && g.call(a, q);
